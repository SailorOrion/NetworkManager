...
GVariant * _nm_setting_vpn_split_excludes_to_dbus(_NM_SETT_INFO_PROP_TO_DBUS_FCN_ARGS _nm_nil);

gboolean _nm_setting_vpn_split_excludes_from_dbus(_NM_SETT_INFO_PROP_FROM_DBUS_FCN_ARGS _nm_nil);
